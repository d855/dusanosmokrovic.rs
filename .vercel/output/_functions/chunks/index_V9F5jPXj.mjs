import { c as createComponent, b as VALID_INPUT_FORMATS } from './consts_DMSz0ZFM.mjs';
import 'piccolore';
import { r as renderTemplate, m as maybeRenderHead, h as addAttribute, n as renderComponent, o as renderSlot, p as renderHead, q as generateCspDigest, s as spreadAttributes, u as unescapeHTML, v as removeBase, b as isRemotePath, A as AstroError, w as UnknownContentCollectionError } from './entrypoint_CBSjWzrl.mjs';
import 'clsx';
import 'html-escaper';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BmfDWP1P.mjs');
...
I build
<span class="relative inline-block"> <span class="relative z-10">software</span> <span class="absolute bottom-1 left-0 w-full h-4 sm:h-6 bg-coral -z-0 -rotate-1"></span> </span> <br>that solves
<span class="relative inline-block"> <span class="relative z-10">real problems</span> <span class="absolute bottom-1 left-0 w-full h-4 sm:h-6 bg-lime -z-0 rotate-1"></span> </span> </h1> <p class="text-lg sm:text-xl max-w-xl mb-10 text-muted-foreground leading-relaxed animate-fade-up" style="animation-delay: 0.35s">
...
Let's talk
<span class="inline-block ml-2 transition-transform group-hover:translate-x-1">&rarr;</span> </a> </div> </div> </div> </section>  <section id="work" class="relative py-24 sm:py-32 px-6"> <div class="max-w-7xl mx-auto"> <div class="flex items-center gap-4 mb-16" data-animate> <h2 class="font-heading text-4xl sm:text-5xl font-black uppercase tracking-tight">Latest Work</h2> <div class="flex-1 h-[4px] bg-foreground"></div> </div> <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8"> <!-- B2B Wholesale Ecommerce --> <article data-animate data-animate-delay="1" class="group border-3 border-black dark:border-white bg-card hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_var(--lime)] transition-all duration-200 p-6 flex flex-col"> <span class="font-mono text-xs uppercase tracking-widest text-muted-foreground mb-3">01 / Ecommerce</span> <h3 class="font-heading text-xl font-bold uppercase mb-3 leading-tight">B2B Wholesale Ecommerce Platform</h3> <p class="text-muted-foreground text-sm leading-relaxed mb-4 flex-1">
Multi-tier pricing, customer-specific catalogs, bulk order flows, and quote management. Account managers handle hundreds of B2B buyers with negotiated rates, credit limits, and per-customer SKU visibility. Custom checkout with PO numbers and net-terms support.
</p> <div class="flex flex-wrap gap-2 pt-4 border-t-2 border-border"> <span class="text-xs font-bold uppercase tracking-wider bg-lime text-black px-2 py-0.5 border border-black">Laravel</span> <span class="text-xs font-bold uppercase tracking-wider bg-lime text-black px-2 py-0.5 border border-black">Inertia</span> <span class="text-xs font-bold uppercase tracking-wider bg-lime text-black px-2 py-0.5 border border-black">React</span> <span class="text-xs font-bold uppercase tracking-wider bg-lime text-black px-2 py-0.5 border border-black">Postgres</span> </div> </article> <!-- Inquiry Platform --> <article data-animate data-animate-delay="2" class="group border-3 border-black dark:border-white bg-card hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_var(--coral)] transition-all duration-200 p-6 flex flex-col"> <span class="font-mono text-xs uppercase tracking-widest text-muted-foreground mb-3">02 / SaaS</span> <h3 class="font-heading text-xl font-bold uppercase mb-3 leading-tight">Inquiry Platform</h3> <p class="text-muted-foreground text-sm leading-relaxed mb-4 flex-1">
Lead intake and routing tool. Public forms feed a back-office where teams triage, assign, and respond to inquiries with full thread history. Role-based access, SLA tracking, email notifications, and a clean Inertia-powered UI for non-technical staff.
</p> <div class="flex flex-wrap gap-2 pt-4 border-t-2 border-border"> <span class="text-xs font-bold uppercase tracking-wider bg-coral text-white px-2 py-0.5 border border-black">Laravel</span> <span class="text-xs font-bold uppercase tracking-wider bg-coral text-white px-2 py-0.5 border border-black">Inertia</span> <span class="text-xs font-bold uppercase tracking-wider bg-coral text-white px-2 py-0.5 border border-black">React</span> <span class="text-xs font-bold uppercase tracking-wider bg-coral text-white px-2 py-0.5 border border-black">Postgres</span> </div> </article> <!-- WeChat Mini App --> <article data-animate data-animate-delay="3" class="group border-3 border-black dark:border-white bg-card hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_var(--lime)] transition-all duration-200 p-6 flex flex-col"> <span class="font-mono text-xs uppercase tracking-widest text-muted-foreground mb-3">03 / Mobile</span> <h3 class="font-heading text-xl font-bold uppercase mb-3 leading-tight">WeChat Mini App</h3> <p class="text-muted-foreground text-sm leading-relaxed mb-4 flex-1">
Mobile companion to the Inquiry Platform, built natively inside WeChat for the Chinese market. Users submit and track inquiries on the go — WeChat login, QR code login for the web app, and inquiry threads — all powered by the same Laravel API.
</p> <div class="flex flex-wrap gap-2 pt-4 border-t-2 border-border"> <span class="text-xs font-bold uppercase tracking-wider bg-lime text-black px-2 py-0.5 border border-black">WXML</span> <span class="text-xs font-bold uppercase tracking-wider bg-lime text-black px-2 py-0.5 border border-black">WXSS</span> <span class="text-xs font-bold uppercase tracking-wider bg-lime text-black px-2 py-0.5 border border-black">Laravel API</span> <span class="text-xs font-bold uppercase tracking-wider bg-lime text-black px-2 py-0.5 border border-black">Postgres</span> </div> </article> </div> </div> </section>  <section id="writings" class="relative py-24 sm:py-32 px-6 border-t-4 border-black dark:border-white"> <div class="max-w-7xl mx-auto"> <div class="flex items-center gap-4 mb-16" data-animate> <h2 class="font-heading text-4xl sm:text-5xl font-black uppercase tracking-tight">Writings</h2> <div class="flex-1 h-[4px] bg-foreground"></div> </div> <div class="grid gap-6 max-w-3xl"> ${posts.map((post, i) => renderTemplate`<a${addAttribute(`/blog/${post.id}`, "href")} data-animate${addAttribute(String(i + 1), "data-animate-delay")} class="group flex items-baseline justify-between gap-4 border-b-2 border-border pb-6 hover:border-coral transition-colors"> <div> <h3 class="font-heading text-lg sm:text-xl font-bold uppercase group-hover:text-coral transition-colors">${post.data.title}</h3> <p class="text-muted-foreground text-sm mt-1">${post.data.description}</p> </div> <span class="text-xs text-muted-foreground whitespace-nowrap font-mono text-right"> ${post.data.date.toLocaleDateString("en-US", { year: "numeric", month: "2-digit" }).replace("/", "-")} <span class="block">${post.readingMinutes} min</span> </span> </a>`)} </div> </div> </section>  <footer id="contact" class="border-t-4 border-black dark:border-white bg-foreground text-background py-16 px-6"> <div class="max-w-7xl mx-auto"> <div class="grid md:grid-cols-2 gap-12 items-start"> <div data-animate> <h2 class="font-heading text-3xl sm:text-4xl font-black uppercase tracking-tight mb-4">Let's connect</h2> <p class="text-background/70 max-w-md leading-relaxed">Got a project in mind, want to collaborate, or just say hi? I'm always open to interesting conversations.</p> <a href="mailto:dosmokrovic@yahoo.com" class="inline-block mt-6 font-heading font-bold text-lg border-b-2 border-lime hover:text-lime transition-colors">dosmokrovic@yahoo.com</a> </div> <div data-animate data-animate-delay="1" class="flex flex-col gap-4 md:items-end"> <span class="font-heading text-sm font-bold uppercase tracking-widest text-background/50">Find me on</span> <div class="flex gap-4"> <a href="https://github.com/d855" target="_blank" rel="noopener" class="border-2 border-background/30 hover:border-lime hover:text-lime px-5 py-3 font-heading font-bold text-sm uppercase tracking-wider transition-colors">GitHub</a> <a href="https://linkedin.com/in/dusanosmokrovic" target="_blank" rel="noopener" class="border-2 border-background/30 hover:border-lime hover:text-lime px-5 py-3 font-heading font-bold text-sm uppercase tracking-wider transition-colors">LinkedIn</a> </div> <p class="text-background/40 text-xs mt-8 font-mono">&copy; 2025 Dušan Osmokrović</p> </div> </div> </div> </footer> ` }));
